                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1"><a href="{{ route('dashboard') }}">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div class="card rated-product bg-secondary">
                            <div class="card-body">
                                ...
                                <div class="product-detail"> <a href="{{ route('dashboard') }}">
                        ...
                        <div class="card product-review">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="person-detail"><a href="{{ route('dashboard') }}">
                ...
                <div class="card weekend-view">
                    <div class="card-body">
                        ...
                        <div class="product-detail">
                            ...
                            <h5>Upto 50% Off Discount</h5><a class="btn" href="{{ route('dashboard')}}">See More</a>
                        </div>
                    </div>
                </div>
            </div>
